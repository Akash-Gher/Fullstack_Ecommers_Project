...
import com.skyfashion.backend.security.MyUserDetails;
import com.skyfashion.backend.security.UserCredentials;
...
public class UserController {
   ...
   @Autowired
    ...
    public ResponseEntity<String> signUp(@RequestBody User user) {
        ...
        com.skyfashion.backend.entity.User checkIfExists = userRepo.findByName(user.getUsername());
    ...
    public ResponseEntity<UserDetails> login(@RequestBody UserCredentials userCredentials) throws AuthenticationException {
        ...
        User user = userRepo.findByName(userCredentials.getUsername());
